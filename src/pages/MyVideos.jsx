...
const MyVideos = () => {
  ...
  const togglePublish = useMutation({
    ...
    onSuccess: (data) => {
      queryClient.invalidateQueries(["myVideos", channelId]);
      toast.success(
        data?.message || "Video publish status toggled successfully"
      );
    },
    onError: (error) => {
  ...
  return (
    <main>
      ...
      <div className="my-8">
        ...
        {!myVideos?.videos ? (
          <p className="text-lg flex flex-wrap justify-center font-semibold bg-slate-100 p-5 text-blue-600">
              ...
              >
                ...
                <div className="mt-2 flex justify-between">
                  ...
                  <button
                    ...
                    className={`${
                      video.isPublished ? "text-green-600" : "text-gray-600"
                    } hover:underline`}
                  >
