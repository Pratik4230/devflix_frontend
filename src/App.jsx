      ...
      <BrowserRouter basename="/">
        <Routes>
          <Route path="/" element={<Container />}>
            ...
            <Route
              path="/video/:videoId"
              element={authUser ? <Video /> : <Navigate to={"/"} />}
            />
            <Route
              path="/profile"
            ...
            <Route
              ...
              element={authUser ? <Channel /> : <Navigate to={"/"} />}
            />
            <Route
            ...
            <Route
              path="/subscriptions"
              element={authUser ? <Subscriptions /> : <Navigate to={"/"} />}
            />
            <Route
              path="/managevideos"
              element={authUser ? <MyVideos /> : <Navigate to={"/"} />}
            />
            <Route
              path="/likedvideos"
              element={authUser ? <LikedVideos /> : <Navigate to={"/"} />}
            />
            <Route
              path="/feedback"
