  ...
  return (
    <nav className=" bg-base-100 dark:bg-black px-7 flex items-center justify-between">
      ...
      <div className="flex items-center">
        ...
        <Link
          to={"/"}
          className="btn btn-ghost dark:text-orange-50 text-xl flex items-center"
        >
          devflix
        </Link>
      </div>
      ...
      <section className="flex gap-4 items-center">
        ...
        <div className="flex items-center dropdown dropdown-end">
          ...
          >
            <Link
              to={"/profile"}
              className=" bg-slate-950 text-lg flex justify-center items-center cursor-pointer rounded-xl h-12 border-b-2  text-white"
            >
              <p>Profile</p>
            </Link>
            <li
              onClick={handleLogout}
              className=" bg-slate-900 text-lg flex justify-center items-center cursor-pointer rounded-xl text-white h-12 w-full border-b-2"
            >
              Logout
            </li>
          </ul>
